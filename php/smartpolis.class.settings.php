<?php
	class smartPolisSettings {
		...
		public function save() {
			...
			file_put_contents($this->settingsFile, '$SMARTPOLIS_SETTINGS = "', FILE_APPEND);
			file_put_contents($this->settingsFile, base64_encode(serialize($this->settings)), FILE_APPEND);
			file_put_contents($this->settingsFile, '";' . "\n", FILE_APPEND);
			file_put_contents($this->settingsFile, "?>", FILE_APPEND);
		}
	}
?>
